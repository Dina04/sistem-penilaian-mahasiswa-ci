        ...
        <div class="container">
            <div class="intro-text">
                <div class="img-responsive">
                    <img src="<?= base_url('img\header-bg.png') ?>" width="100%">
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="team-member">
                    <img src="<?= base_url('img\team\1.png') ?>" class="img-responsive img-circle" alt="" width="220px" height="270px">
            ...
            <div class="col-sm-4">
                <div class="team-member">
                    <img src="<?= base_url('img\team\2.png') ?>" class=" img-responsive img-circle" alt="" width="220px" height="270px">
            ...
            <div class="col-sm-4">
                <div class="team-member">
                    <img src="<?= base_url('img\team\3.png') ?>" class="img-responsive img-circle" alt="" width="220px" height="270px">
